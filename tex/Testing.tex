...
\begin{document}
	...
	\newpage
        ...
        \begin{defi}
          \textbf{Mehrfache Bedingungsüberdeckung} - fordert, dass die atomaren Bedingungen mit \underline{allen m\"oglichen Kombinationen} der Wahrheitswerte W und F belegt werden.
        \end{defi}
        ...
        \begin{defi}
          \textbf{Funktionale Tests} \textit{engl. Functional Tests} - Testen der Spezifizierten Funktionalität, ohne Kenntniss der internen Struktur des Testlings. Demnach Testf\"alle aus Spezifikation abgeleitet.
        \end{defi}
        \begin{why}
          \begin{enumerate}
        ...
        \subsubsection{Verwednung von Testhelfern}
        Objekte leben nicht isoliert, sondern arbeiten in der Anwendung zusammen. Um trotzdem ein unabh\"angiges Testen zu erm\"oglichen werden beim Testen Testhelfer eingesetzt, die die fehlende Funtionalit\"at simulieren. Dann werden die Testhelfer sukzessiv durch echte Implemntierungen ersetzt.
